...
SECRET_KEY='django-insecure-qefk__3x*%ki)&*kdynp@koc%4kha^%bw514!mm9jrdb5f*s9#'
...
SPECTACULAR_SETTINGS = {
    ...
    'DESCRIPTION': 'A RESTful API for managing tasks with JWT authentication',
    'VERSION': '1.0.0',
...
# SimpleJWT Settings (if not already configured)
SIMPLE_JWT = {
